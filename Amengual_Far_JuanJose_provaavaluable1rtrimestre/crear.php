...
<form action="listado.php" method="POST">
    ...
    <a href= "listado.php" class="btn btn-primary btn-custom">Crear</a>
    <a href= "" class="btn btn-secondary btn-custom">Limpiar</a>
    <a href= "listado.php" class="btn btn-secondary btn-custom">Volver</a>
